<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center  text-green-400 dark:text-gray-300 space-x-4">
            <div class="flex items-center space-x-4">
                <a href="{{ route('history') }}" class="text-green-600 hover:text-green-400">
            ...
            <a href="{{ route('transaction.print', $transaction->id) }}"
                class="bg-green-400 dark:bg-green-900 hover:bg-green-300 dark:hover:bg-green-700 text-white dark:text-gray-100 py-1 px-4 rounded">
                print
            </a>
        </div>
    </x-slot>
